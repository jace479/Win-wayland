#!/usr/bin/env bash
# ==============================================================================
# ntKDE Individual Application Launcher
# ==============================================================================
# Launches KDE applications natively onto WSLg display (:0 / wayland-0)
# ==============================================================================
...
if [[ -S "$XDG_RUNTIME_DIR/nt-plasma-kwin" ]]; then
    export WAYLAND_DISPLAY="nt-plasma-kwin"
else
...
case "$app" in
    ...
    krunner)
        ...
        ;;
    kickoff|menu)
        qdbus org.kde.plasmashell /PlasmaShell org.kde.PlasmaShell.activateLauncherMenu >>"$log_file" 2>&1 || true
        ;;
    discover)
        nohup plasma-discover "$@" </dev/null >>"$log_file" 2>&1 &
        ;;
    *)
